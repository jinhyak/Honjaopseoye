...
<script type="text/javascript">
    function btn_find() {
      if($("#ins_name").val() == null || $("#ins_name").val() == "" ) {
         ...
         $("#ins_name").focus();
         return false;
      } else if ($("#ins_ph").val() == null || $("#ins_ph").val() == "") {
         alert("전화번호를 입력해주세요.");
         $("#ins_ph").focus();
         return false;
      }else{
    	  ...
    	  $.ajax({
    		 url : "../../member/empty/idSearch.test"
    		,method : "post"
    		,data : param
...
<script type="text/javascript">
   function btn_efind(){
      if ($("#e_name").val() == null || $("#e_name").val() == "" ) {
    	 ...
    	 var param = "../../member/empty/idSearch.test"
      }
   }
</script>
</head>
											...
											<div class="left aligned column">
                                             ...
                                             <option value="th_ph">019</option>
														...
														<div class="ui input focus" style="width: 250px">
															<input type="text" placeholder="전화번호" id="ins_ph"
																name="ins_ph">
														</div>
													</div>
													<div style="margin-top: 10px; margin-left: 170px;">
														<button class="ui teal button" id="btn_search"
													...
													<div style="text-align: left; margin-left: 50px;">
														<div class="ui column container">
															...
															<div style="margin-top: 10px; margin-left: 90px;">
																<button class="ui teal button" type="button"
