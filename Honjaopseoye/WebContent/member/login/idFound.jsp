                  ...
                  <div class="ui center aligned one column grid">
                     ...
                     <div class="center aligned column" style="height:25%; vertical-align:middle;">
                        ...
                        <div style="margin-top:50px;">
                        	 <button class="ui ui inverted primary button" onClick="btn_login()" style="width:250px; height:50px" onClick="btn_find()">로그인</button>
                        	 <button class="ui ui inverted primary button" onClick="btn_pwSearch()" style="width:250px; height:50px" onClick="btn_find()">비밀번호찾기</button>
                        </div>
                        </div>
                     </div>
                  </div>
